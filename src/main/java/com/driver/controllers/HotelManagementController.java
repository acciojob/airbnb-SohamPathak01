...
public class HotelManagementController {
    ...
    public String addHotel(@RequestBody Hotel hotel){
        ...
        try {
            boolean status = hotelService.createHotel(hotel);
            if (status) {
                return "SUCCESS";
            }
            return "FAILURE";
    ...
    public int getBookings(@PathVariable("aadharCard")Integer aadharCard)
    {
        ...
        return bookingService.getNumberOfBookingsByUser(aadharCard);
    }
    ...
    public Hotel updateFacilities(List<Facility> newFacilities,String hotelName){
        ...
        return hotelService.addFacility(newFacilities,hotelName);
    }
